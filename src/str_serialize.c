...
/***************************************************************************//** 
 * @brief Checks if a string value represents a valid number
 *
 * @param[in] input - the pointer to the input string
 *
 * @retval true in case the value is a number
 * @retval false in case the value is not a number
 ******************************************************************************/
